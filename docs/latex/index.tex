...
\hypertarget{index}{}\label{index}\index{ViennaGameAILibrary@{ViennaGameAILibrary}}
\label{index_md__d_1_2_uni_vie_2_sem_015_2_master_2_vienna_game_a_i_library_2_r_e_a_d_m_e}%
\Hypertarget{index_md__d_1_2_uni_vie_2_sem_015_2_master_2_vienna_game_a_i_library_2_r_e_a_d_m_e}%
...
From path finding, to state machines, decision trees and steering algorithms, Vienna Game AI Library should encompass everything a game developer might need in creating a 2D RTS game. In order to show its efficiency and applicability, each implemented feature is showcased in a respective demo created with the help of the \href{https://github.com/raysan5/raylib}{\texttt{ raylib}} library.\hypertarget{index_autotoc_md1}{}\doxysection{\texorpdfstring{Project structure}{Project structure}}\label{index_autotoc_md1}
...
\end{DoxyItemize}\hypertarget{index_autotoc_md2}{}\doxysection{\texorpdfstring{Setup -\/ Windows}{Setup -\/ Windows}}\label{index_autotoc_md2}
...
\item Clang
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{index_autotoc_md4}{}\doxysubsection{\texorpdfstring{Build and run the project}{Build and run the project}}\label{index_autotoc_md4}
...
\end{DoxyEnumerate}\hypertarget{index_autotoc_md5}{}\doxysubsection{\texorpdfstring{To run different demos}{To run different demos}}\label{index_autotoc_md5}
...
\end{DoxyCode}
\hypertarget{index_autotoc_md6}{}\doxysection{\texorpdfstring{Code documentation}{Code documentation}}\label{index_autotoc_md6}
Documentation is generated using Doxygen. To see it, open {\ttfamily index.\+html} which can be found in the {\itshape docs} folder.\hypertarget{index_autotoc_md7}{}\doxysection{\texorpdfstring{How to use each feature the library provides}{How to use each feature the library provides}}\label{index_autotoc_md7}
\begin{quote}
...
\hypertarget{index_autotoc_md8}{}\doxysubsection{\texorpdfstring{1. {\bfseries{Data structures and data types}}}{1. {\bfseries{Data structures and data types}}}}\label{index_autotoc_md8}
...
In this example, the decision nodes are represented by the rectangular objects ({\itshape is\+Guard\+Close}, {\itshape is\+Burglar\+Close}, etc.).\hypertarget{index_autotoc_md11}{}\doxysubsection{\texorpdfstring{4. {\bfseries{State machines}}}{4. {\bfseries{State machines}}}}\label{index_autotoc_md11}
\begin{quote}
...
This method is responsible with managing the states and transitions between them every frame.\hypertarget{index_autotoc_md12}{}\doxysubsection{\texorpdfstring{5. {\bfseries{Steering behaviors}}}{5. {\bfseries{Steering behaviors}}}}\label{index_autotoc_md12}
Demo examples\+:
...
\end{DoxyItemize}\hypertarget{index_autotoc_md13}{}\doxysubsubsection{\texorpdfstring{5.\+1. {\bfseries{Seek}}}{5.\+1. {\bfseries{Seek}}}}\label{index_autotoc_md13}
\begin{quote}
...
In the example above, the blue object is seeking the player (yellow object).\hypertarget{index_autotoc_md14}{}\doxysubsubsection{\texorpdfstring{5.\+2. {\bfseries{Flee}}}{5.\+2. {\bfseries{Flee}}}}\label{index_autotoc_md14}
...
In the example above, the green object is fleeing the player (yellow object), while also staying inside the borders of the window.\hypertarget{index_autotoc_md15}{}\doxysubsubsection{\texorpdfstring{5.\+3. {\bfseries{Arrive}}}{5.\+3. {\bfseries{Arrive}}}}\label{index_autotoc_md15}
...
In this example, the purple object is following the player (yellow object).\hypertarget{index_autotoc_md17}{}\doxysubsubsection{\texorpdfstring{5.\+5. {\bfseries{Evade}}}{5.\+5. {\bfseries{Evade}}}}\label{index_autotoc_md17}
\texorpdfstring{$>$}{>} Demo example\+: {\itshape Demo/src/\+Steering\+Behaviors/demo\+\_\+\+Pursue\+And\+Evade.\+cpp}
...
In this example, the pink object is following the player (yellow object), while also staying inside the borders of the window.\hypertarget{index_autotoc_md18}{}\doxysubsubsection{\texorpdfstring{5.\+6. {\bfseries{Wander}}}{5.\+6. {\bfseries{Wander}}}}\label{index_autotoc_md18}
...
In this example, the red line is the character\textquotesingle{}s velocity which changes every frame depending on the randomly chosen point.\hypertarget{index_autotoc_md19}{}\doxysubsubsection{\texorpdfstring{5.\+7. {\bfseries{Steer}}}{5.\+7. {\bfseries{Steer}}}}\label{index_autotoc_md19}
...
Please note that the {\ttfamily update\+Position()} method must be called after applying the steering force, otherwise the boid\textquotesingle{}s position will not change according to the new calculations.\hypertarget{index_autotoc_md20}{}\doxysubsection{\texorpdfstring{6. {\bfseries{Flocking}}}{6. {\bfseries{Flocking}}}}\label{index_autotoc_md20}
...
→ {\ttfamily centering\+Factor} determines how strongly boids steer to match the average position of their neighbours.
  ...
  \hypertarget{index_autotoc_md21}{}\doxysection{\texorpdfstring{Resources}{Resources}}\label{index_autotoc_md21}
